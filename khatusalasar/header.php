...
<head>
	...
	<title>Typecase Admin Panel</title>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'size.php') || ($cur_page == 'collection.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'collection-add.php') || ($cur_page == 'size-add.php') || ($cur_page == 'collection-edit.php') || ($cur_page == 'color.php') || ($cur_page=='color-edit.php') || ($cur_page=='color-add.php') ) {echo 'active';} ?>">
                        <a href="#">
                            <i class="fa fa-cogs"></i>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'meta_tag.php') ) {echo 'active';} ?>">
			          <a href="meta_tag.php">
