...
$statement = $pdo->prepare("SELECT * FROM tbl_order WHERE OrderStatus=?");
...
$statement = $pdo->prepare("SELECT * FROM tbl_order WHERE orderDate=?");
$statement->execute(array($currentDate));
$todayorder = $statement->rowCount();
?>
