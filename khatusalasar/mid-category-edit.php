...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_mid_category SET home_img=?,show_home=?,mcat_name=?,tcat_id=?,meta_title=?,meta_keyword=?,meta_description=?,slug=? WHERE mcat_id=?");
		$statement->execute(array($final_name,$_POST['show_on_home'],$_POST['mcat_name'],$_POST['tcat_id'],$_POST['mtitle'],$_POST['mkey'],$_POST['mdescr'],$slug,$_REQUEST['id']));  
