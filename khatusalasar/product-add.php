					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<select name="collection" class="form-control select2">
									...
									foreach ($result as $row) {
										?>
										<option value="<?php echo $row['id']; ?>"><?php echo $row['collection']; ?></option>
										<?php
									}
									?>
							</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="p_vendor" class="form-control">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" name="p_delivery" class="form-control">
							</div>
						</div>	
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea name="p_short_description" class="form-control" cols="30" rows="6" id=""></textarea>
							</div>
						</div>	
