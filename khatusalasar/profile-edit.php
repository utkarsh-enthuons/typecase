...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
    	...
    	if($_SESSION['user']['photo']!='') {
    		unlink('../assets/images/user-profile/'.$_SESSION['user']['photo']);	
    	}

    	// updating the data
    	$final_name = 'user-'.$_SESSION['user']['id'].'.'.$ext;
        move_uploaded_file( $path_tmp, '../assets/images/user-profile/'.$final_name );
								...
								<div class="box-body">
									...
									<div class="form-group">
							            ...
							            <div class="col-sm-6" style="padding-top:6px;">
							                <img src="../assets/images/user-profile/<?php echo $photo; ?>" class="existing-photo" width="140">
							            </div>
							        </div>
