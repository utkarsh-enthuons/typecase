					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td style="width:150px;"><img src="../assets/images/slider-image/<?php echo $row['photo']; ?>" alt="<?php echo $row['heading']; ?>" style="width:140px;"></td>
									
									<td style="width:150px;"><img src="../assets/images/slider-image/<?php echo $row['mphoto']; ?>" alt="<?php echo $row['heading']; ?>" style="width:140px;"></td>
