...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_top_category SET description=?,tcat_name=?,show_on_menu=?,meta_title=?,meta_keyword=?,meta_description=?,slug=? WHERE tcat_id=?");
		$statement->execute(array($_POST['description'],$_POST['tcat_name'],$_POST['show_on_menu'],$_POST['mtitle'],$_POST['mkey'],$_POST['mdesc'],$_POST['slug'],$_REQUEST['id']));
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="description" id="editor1" class="form-control" cols="30" rows="6"
                                    id=""><?php echo $row['description']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
