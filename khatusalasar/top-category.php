            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        <a href="top-category-edit.php?id=<?php echo $row['tcat_id']; ?>" class=" btn-primary btn-xs">Edit</a>
	                        <a href="#" class="btn-danger btn-xs" data-href="top-category-delete.php?id=<?php echo $row['tcat_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
	                    </td>
	                </tr>
            		<?php
            	}
