                ...
                <div class="col-md-9 col-lg-6 mx-auto">
                    <div class="card-box review-form">
                        <div class="card-box-body">
                            <h1 class="text-center title2 text-black mb-1">Reset Password</h1>
                            <form action="" method="post" class="">
                                <div class="form-group">
                                    <label for="" class="text-black">Old Password*</label>
                                ...
                                <button class="btn btn-aqua w-100">Reset Password Now</button>
                            </form>
                        </div>
                    </div>
                </div>
